...
final class AuthorService[F[_] : Concurrent](authorRepository: AuthorRepository[F],
                                             bookRepository: BookRepository[F]) extends Http4sDsl[F] {
  val prefixPath = "api/v1/authors"
